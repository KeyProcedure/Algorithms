 ...
 *
 *  Reads an image, prints square of energies of pixels,
 *  a vertical seam, and a horizontal seam.
 *
...
public class PrintSeams {
  ...
  /**
   * Prints the seam of the picture and the energy matrix.
   * @param carver SeamCarver object
   * @param seam array of pixels representing the seam
   * @param direction orientation of the seam
   */
