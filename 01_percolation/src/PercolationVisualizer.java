 ...
 *
 * This program takes the name of a file as a String value.
 * From that file, it
...
public class PercolationVisualizer {
  private static final int DELAY = 100; // delay in milliseconds (controls animation speed)
  ...
  /**
   * Creates a visual representation of the percolation grid.
   * @param args not used
   */
  public static void main(String[] args) {
    final String fileName = "01_percolation/test/input10.txt"; // input test file
